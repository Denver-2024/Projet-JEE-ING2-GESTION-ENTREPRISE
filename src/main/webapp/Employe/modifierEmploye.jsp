...
<head>
    ...
    <style>
        ...
        .modif { background-color: white; padding: 25px 40px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        .nextAction { display: flex; justify-content: space-evenly; align-items: center; }
    </style>
