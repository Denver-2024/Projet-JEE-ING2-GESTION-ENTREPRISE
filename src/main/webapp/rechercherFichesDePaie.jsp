...
<div class="recherchefiches">
    ...
    <div class="dateperiode">
        <form action="${pageContext.request.contextPath}/rechercher-fiche-de-paie" method="get">
            <input value="${sessionScope.employeFoundMatricule.id_employe}" hidden="hidden" name="employe">
        ...
        <table class="tablefiches">
            ...
            <c:forEach var="fiche" items="${fiches}">
                <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${fiche.dateFiche}" pattern="MMMM yyyy"/>
                    </td>
                    <td class="actionTD">
                        <form action="${pageContext.request.contextPath}/generer-pdf" method="get" target="_blank">
