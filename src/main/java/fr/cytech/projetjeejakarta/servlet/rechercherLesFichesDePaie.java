...
@WebServlet("/rechercher-fiche-de-paie")
public class rechercherLesFichesDePaie extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(startDate.after(endDate)) {
            ...
            req.getRequestDispatcher("rechercherFichesDePaie.jsp").forward(req, resp);
            return;
        }
        ...
        System.out.println("Rechercher les fiche-de-paie "+employe);
