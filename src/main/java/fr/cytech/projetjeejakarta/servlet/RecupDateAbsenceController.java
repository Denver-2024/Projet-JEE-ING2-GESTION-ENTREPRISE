...
@WebServlet("/RecupDateAbsenceController")
public class RecupDateAbsenceController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("Employe/ajouterAbsence.jsp").forward(req, resp);
    }
}
