...
@WebServlet("/recherche-employe")
public class RechercheEmploye extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("id_departement: " + id_departementStr);
        ...
        if(roleStr == null && gradeStr == null && id_departementStr == null  && nom.isBlank() && prenom.isBlank()){
            ...
            request.getRequestDispatcher("rechercheEmploye.jsp").forward(request, response);
            return;
        }
        ...
        if(gradeStr != null){
            try {
                ...
                //System.out.println("Invalid grade value: " + gradeStr);
            }
        ...
        System.out.println("nom: " + nom);
        System.out.println("prenom: " + prenom);
        System.out.println("role: " + id_role);
        System.out.println("grade: " + grade);
        System.out.println("id_departement: " + id_departement);
